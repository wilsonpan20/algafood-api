...
public class CozinhaIT {
	...
	public void setUp() {
		...
		jsonCozinhaCorreta = ResourceUtils.getContentFromResource("/json/correto/cozinha-chinesa.json");

		jsonCozinhaIncorreta = ResourceUtils.getContentFromResource("/json/incorreto/cozinha-sem-nome.json");
	...
	public void deveRetornarStatus400_QuandoCadastrarCozinhaSemNome() {
		given().body(jsonCozinhaIncorreta)
				.contentType(ContentType.JSON)
				.accept(ContentType.JSON)
				.when()
				.post()
	...
	public void deveRetornarRespostaEstatusCorretos_QuandoConsultarCozinhaExistente() {
		given().pathParam("cozinhaId", cozinhaBrasileira.getId())
				.accept(ContentType.JSON)
				.when()
				.get("/{cozinhaId}")
				.then()
	...
	public void deveRetornarStatus404_QuandoConsultarCozinhaInexistente() {
		given().pathParam("cozinhaId", ID_COZINHA_INEXISTENTE)
				.accept(ContentType.JSON)
				.when()
				.get("/{cozinhaId}")
				.then()
